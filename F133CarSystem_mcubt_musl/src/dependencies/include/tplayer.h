...
//ÓÃ»§×Ô¶šÒåÒôÐ§ÂË²šÆ÷µÄÆµ¶ÎÊý£¬ÓÃ»§ÐèÒª×ÔÐÐÉè¶šž÷Æµ¶ÎµÄÂË²šÏµÊý
#define USR_EQ_BAND_CNT             (10)
#define USR_EQ_NEGATIVE_PEAK_VALUE  (-12)
#define USR_EQ_POSITIVE_PEAK_VALUE  (+12)
typedef enum AudioEqType           /* ÒôÐ§ÀàÐÍ¶šÒå                         */
{
    AUD_EQ_TYPE_NORMAL = 0,       /* ×ÔÈ»                                 */
    AUD_EQ_TYPE_DBB,              /* ÖØµÍÒô                               */
    AUD_EQ_TYPE_POP,              /* Á÷ÐÐ                                 */
    AUD_EQ_TYPE_ROCK,             /* Ò¡¹ö                                 */
    AUD_EQ_TYPE_CLASSIC,          /* ¹Åµä                                 */
    AUD_EQ_TYPE_JAZZ,             /* ŸôÊ¿                                 */
    AUD_EQ_TYPE_VOCAL,            /* ÓïÑÔ                                 */
    AUD_EQ_TYPE_DANCE,            /* ÎèÇú                                 */
    AUD_EQ_TYPE_SOFT,             /* ÈáºÍ                                 */
    AUD_EQ_TYPE_USR_MODE = 0xff,    /* ÓÃ»§Ä£Êœ, pbuffer = __s8 UsrEqArray[USR_EQ_BAND_CNT],
                                       Ã¿žöµãµÄÖµÎª:
...
// add by zkswe 2024-11-04
int TPlayerSetVideoOutputMaxSize(TPlayer* p, int maxWidth, int maxHeight);
// add end
...
// add by zkswe
int TPlayerSetAudioGain(TPlayer* p, float gain);
// add end
